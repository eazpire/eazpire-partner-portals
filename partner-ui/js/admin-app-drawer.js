...
export const ADMIN_APPS = [
  ...
  },
  {
    ...
    route: "/marketing",
    iconSvg:
      '<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M4 19.5 12 4l8 15.5h-3.1L12 9.6 7.1 19.5H4Zm4.2-1.5h7.6L12 12.2 8.2 18Z"/></svg>',
  },
];
